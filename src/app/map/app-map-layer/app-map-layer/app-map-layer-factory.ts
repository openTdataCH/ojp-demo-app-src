...
export class AppMapLayerFactory {
  public static init(language: OJP_Next.Language, layerKey: string, map: mapboxgl.Map, appMapLayerOptions: AppMapLayerOptions, userTripService: UserTripService): AppMapLayer {
