...
20.August 2026 - [TR - additional filter for coach (instead of bus) #400](https://github.com/openTdataCH/ojp-demo-app-src/issues/400), [PR #402](https://github.com/openTdataCH/ojp-demo-app-src/pull/402)
- Update TR filters
...
- Updates TR defaults - [PR #387](https://github.com/openTdataCH/ojp-demo-app-src/pull/387)
  ...
  - remove BETA from `REQUESTOR_REF`
...
10.March 2026
- Fix places init - [PR #361](https://github.com/openTdataCH/ojp-demo-app-src/pull/361)
  - allow correct place init when using custom backends
- Improves errors handling - [PR #360](https://github.com/openTdataCH/ojp-demo-app-src/pull/360)
...
- Migrate TR to use ojp-sdk-next - [PR #337](https://github.com/openTdataCH/ojp-demo-app-src/pull/337)
  - use TR from `ojp-sdk-next`, extract Trip, Leg + other related models from legacy SDK
  - removes `ojp-sdk-legacy` dependency
  - adds `TODOTRIPMIGRATION` note points for OJPv1 left-over features
  - other improvements
    - computes / display distance for transfer legs
    - fix via feature
