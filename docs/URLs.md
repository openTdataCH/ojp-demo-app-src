...
| trip_datetime | `2025-08-01 10:00` | Trip datetime in `yyyy-MM-dd HH:mm` format. Other formats are working as well, i.e.  `2025-08-01`, `2025-09-17T11:15:00`, `29.Dec.2025 10:00`, if supplied, will take precedence over day/time below |
| day | `2025-08-01` | Trip day in `yyyy-MM-dd` format. Used together with `time` below. Ignored if `trip_datetime` is set. |
| time | `10:00` | Trip datetime in `HH:mm` format. Used together with `day` above |
| arr | `yes` | If set, arrival at given day/time will be used, otherwise departure (default) |
...
| Example | OJP 1 | OJP 2 | Comments |
|-|-|-|-|
| Own Bycicle + Public Transport | [Bern](https://opentdatach.github.io/ojp-demo-app/search?from=46.952926,7.426087&to=8588998&mode_types=mode_at_start&transport_modes=cycle&v=1) | N / A |  |
| Shared Scooter + Public Transport | [Bern](https://opentdatach.github.io/ojp-demo-app/search?from=46.952926,7.426087&to=8588998&mode_types=mode_at_start&transport_modes=escooter_rental&v=1) | N / A |  |
